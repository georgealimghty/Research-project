...
type EnrichedFlow struct {
	...
	Tid                           uint32                      `protobuf:"varint,2600,opt,name=Tid,proto3" json:"Tid,omitempty"` // Added New for Tagging the matched data
	...
	Inlist          bool   `protobuf:"varint,2976,opt,name=inlist,proto3" json:"inlist,omitempty"`
	// modify/snmp
	...
	SrcAsPath     []uint32 `protobuf:"varint,2301,rep,packed,name=src_as_path,json=srcAsPath,proto3" json:"src_as_path,omitempty"`
	DstAsPath     []uint32 `protobuf:"varint,2302,rep,packed,name=dst_as_path,json=dstAsPath,proto3" json:"dst_as_path,omitempty"`
...
func (x *EnrichedFlow) GetTid() uint32 {
	if x != nil {
		return x.Tid
	}
	return 0
...
func (x *EnrichedFlow) GetInlist() bool {
	if x != nil {
		return x.Inlist
	}
	return false
...
const file_pb_enrichedflow_proto_rawDesc = "" +
	"\n" +
	"\x15pb/enrichedflow.proto\x12\x06flowpb\"\xa9.\n" +
	"\fEnrichedFlow\x121\n" +
	...
	"\x06DstCid\x18\xdd\x0f \x01(\rR\x06DstCid\x12\x11\n" +
	"\x03Tid\x18\xa8\x14 \x01(\rR\x03Tid\x12F\n" +
	...
	"\x0fSamplerHostName\x18\x8a\x11 \x01(\tR\x0fSamplerHostName\x12\x17\n" +
	"\x06inlist\x18\xa0\x17 \x01(\bR\x06inlist\x12\x1d\n" +
	...
	"\vsrc_as_path\x18\xfd\x11 \x03(\rR\tsrcAsPath\x12\x1f\n" +
	"\vdst_as_path\x18\xfe\x11 \x03(\rR\tdstAsPath\"]\n" +
	"\bFlowType\x12\x0f\n" +
